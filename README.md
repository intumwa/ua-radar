...
## Running the crawl
The [crawler](https://github.com/intumwa/crawler) repository (last updated on 03/11/2024) provides the code and instructions on how to crawl websites prior to running UA-RADAR for similarity analysis.
