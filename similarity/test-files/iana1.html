...
<article class="hemmed sidenav">
	...
	<h1>Domain Name Services</h1>

<p>We operate and maintain a number of key aspects of the DNS, including the root zone, and
    the <span class="domain">.int</span> and <span class="domain">.arpa</span> domains.</p>
 
<p><a href="/domains/root">The DNS Root Zone</a> 
<br/>The root is the upper-most part of the DNS hierarchy, and involves delegating administrative
responsibility of “top-level domains”, which are the last segment of a domain 
name, such as <span class="domain">.com</span>, <span class="domain">.uk</span> and <span class="domain">.nz</span>. 
...
the existing operators.</p>

<p><a href="/domains/int">.INT</a><br/>
The <span class="domain">.int</span> top-level domain, designed for the sole use of
cross-national organisations, such as treaty organisations, that do not 
naturally fit into a specific country’s top-level domain. For example, <span class="domain">who.int</span> for the World Health Organisation.</p>

<p><a href="/domains/arpa">.ARPA</a><br/>
The <span class="domain">.arpa</span> domain is used internally by Internet protocols, such as for reverse 
...
Board, which has policy responsibility for <span class="domain">.arpa</span>.</p> 

<p><a href="/domains/idn-tables">IDN Practices Repository</a><br/>
To help foster the deployment of Internationalised Domain Names (IDNs), a repository of &ldquo;IDN tables&rdquo; which document the permissable characters for different languages and scripts provided for registration by different top-level domain registries. The repository is informative, and designed for information sharing.</p>

<p><a href="/dnssec">Root Key Signing Key</a><br/>
The Root Key Signing Key provides verification of the DNSSEC-signed root zone.</p>

<p><a href="/domains/special">Special Purpose Domains</a><br/>
A number of special domains are reserved or managed for demonstration purposes, or for future use.</p>
